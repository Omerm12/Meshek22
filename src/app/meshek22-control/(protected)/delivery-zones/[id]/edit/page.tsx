...
import { updateDeliveryZone } from "@/app/meshek22-control/(protected)/delivery-zones/actions";
  ...
  return (
    <div>
      ...
      <nav className="flex items-center gap-1.5 text-sm text-gray-400 mb-5" aria-label="פירורי לחם">
        <Link href={`${ADMIN_BASE_PATH}/delivery-zones`} className="hover:text-gray-700 transition-colors">
          אזורי משלוח
        </Link>
