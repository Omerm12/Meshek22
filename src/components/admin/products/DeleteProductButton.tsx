      ...
      {open && (
        <>
          ...
          >
            ...
            <h2 id="delete-product-title" className="text-base font-bold text-gray-900 mb-1">
              מחיקת מוצר
            </h2>
            <p className="text-sm text-gray-500 mb-4">
              ...
              <br />
              כל הגרסאות יימחקו יחד עם המוצר. פעולה זו אינה ניתנת לביטול.
            </p>
