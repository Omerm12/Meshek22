...
export function DeleteSettlementButton({ id, name }: DeleteSettlementButtonProps) {
  ...
  const handleDelete = () => {
    ...
    startTransition(async () => {
      try {
        ...
        console.error("[DeleteSettlementButton] delete failed", err);
