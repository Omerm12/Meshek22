...
const FOOTER_LINKS = {
  shop: [
    { label: "ירקות",         href: "/category/yerakot" },
    { label: "פירות",          href: "/category/perot" },
    { label: "עשבי תיבול",    href: "/category/isvey-tivul" },
    { label: "ירקות שורש",    href: "/category/shoresh" },
    { label: "ביצים ומוצרי חלב", href: "/category/beitsim" },
    { label: "סלטים מוכנים",  href: "/category/salatim" },
  ],
  info: [
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
            ...
            <div className="sm:col-span-2 lg:col-span-1">
              ...
              <p className="text-sm leading-relaxed text-stone-400 mb-6 max-w-xs">
                ירקות ופירות טריים מהמשק ישירות לביתכם. איכות ללא פשרות, כל יום מחדש.
              </p>

              {/* Contact */}
              <div className="flex flex-col gap-2 text-sm">
                <a href="tel:*3722" className="flex items-center gap-2 hover:text-brand-400 transition-colors">
                  <Phone className="h-4 w-4 text-brand-500 shrink-0" />
                  *3722 (א׳–ו׳, 07:00–18:00)
                </a>
                <a href="mailto:hello@meshek22.co.il" className="flex items-center gap-2 hover:text-brand-400 transition-colors">
